...
public class CaptureLayout extends FrameLayout {
    ...
    private int btn_return_visibility = View.VISIBLE;
    ...
    public void setReturnVisibility(int visibility) {
        ...
        btn_return_visibility = visibility;
    }
    ...
    private void initView() {
        ...
        final LayoutParams btn_capture_param = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
...
//                resetCaptureLayout();
    ...
    public void resetCaptureLayout() {
        ...
        if (this.iconLeft != 0)
            ...
            btn_return.setVisibility(btn_return_visibility);
        if (this.iconRight != 0)
