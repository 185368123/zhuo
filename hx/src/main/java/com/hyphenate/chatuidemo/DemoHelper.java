...
//        options.setImPort(31097);
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onAutoAcceptInvitationFromGroup(String groupId, String inviter, String inviteMessage) {
            ...
            if (SingleBeans.getInstance().getGroupStatusBeans().getGroup_match_status().equals("4")){
                EMMessage message = EMMessage.createTxtSendMessage("Hello", groupId);
        ...
        @Override
        public void onOwnerChanged(String groupId, String newOwner, String oldOwner) {//当群主改变时调用
        }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactInvited(String username, String reason) {
            ...
            LogUtils.logd("收到好友邀请："+username+"---"+reason);
...
//                break;
    ...
    private void notifyNewInviteMessage(InviteMessage msg){
        ...
        SingleBeans.getInstance().getUnReadBean().setNewFriendNum(inviteMessgeDao.getUnreadMessagesCount());
        new RxManager().post(RxBusConstants.UNREAD_MSG_COUNT,inviteMessgeDao.getUnreadMessagesCount());
	...
	private EaseUser getUserInfo(String username){
        ...
        EaseUser user = null;
        if(username.equals(EMClient.getInstance().getCurrentUser())) {//获取自己的头像
            user=new EaseUser(username);
            user.setNickname(UserInfoProvider.getNickName());
            user.setAvatar(UserInfoProvider.getPhotoLink());
            return user;
        }
