...
public interface GetUserMsgConstract {
    interface Model extends BaseModel {
        Observable<List<UserMsgBean>> getUserMsg(String user_id);

    }

    interface View extends BaseView {
        void returnUserMsg(UserMsgBean userMsgBean);

    }

    abstract static class Presenter extends BasePresenter<View, Model> {
        public abstract void getUserMsg(String user_id);
