...
public class DenyPresentModel extends BaseImportPresenter {


    public DenyPresentModel() {
    ...
    public void deny(String from_user_id,String team_id) {
        ...
        RequestCall requestCall = MyOkHttpClient.getPostRequest(UrlConstant.Deny_URL, map, UserInfoProvider.getSessionId());
