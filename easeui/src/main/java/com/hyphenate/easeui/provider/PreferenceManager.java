...
public class PreferenceManager {
     ...
     *
     */
    private static final String UserVideo="user_video";
        ...
        if (preferenceManager == null) {
            synchronized (PreferenceManager.class) {
                if (preferenceManager == null) {
                    ...
                    sharedPreferences = BaseApplication.getAppApplication().getSharedPreferences(
    ...
    public void setUserVideo(String userVideo) {
        editor.putString(PreferenceManager.UserVideo, userVideo);
        editor.commit();
    }


    public String getUserVideo() {
        return sharedPreferences.getString(PreferenceManager.UserVideo, "");
    }
