...
public class UserInfoProvider {
    ...
    public static String getUserVideo() {
        return PreferenceManager.getPreferenceManager().getUserVideo();
    }

    public static void setUserVideo(String userVideo) {
        PreferenceManager.getPreferenceManager().setUserVideo(userVideo);
    }
}
