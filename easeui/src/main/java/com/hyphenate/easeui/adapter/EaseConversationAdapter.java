...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            if (group != null && group.getGroupName().contains("深大")) {
                holder.avatar.setImageResource(R.drawable.shenda);
            } else if (group != null && group.getGroupName().contains("深职")) {
                holder.avatar.setImageResource(R.drawable.shenzhi);
            } else {
            ...
            if (room != null && room.getName().contains("深大")) {
                holder.avatar.setImageResource(R.drawable.shenda);
            } else if (room != null && room.getName().contains("深职")) {
                holder.avatar.setImageResource(R.drawable.shenzhi);
            } else {
                holder.avatar.setImageResource(R.drawable.ease_group_icon);
            }
