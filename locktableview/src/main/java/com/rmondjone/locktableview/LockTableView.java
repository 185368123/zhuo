...
public class LockTableView {
     ...
     * 我的数据
     */
    private ArrayList<String> mineData = new ArrayList<>();
    /**
     * 我的左上角视图
     */
    private TextView mineTitleView;
    /**
     * 我的排名
     */
    private CustomHorizontalScrollView mineScrollView;
     ...
     */
    public LockTableView(Context mContext, ViewGroup mContentView, ArrayList<ArrayList<String>> mTableDatas,ArrayList<String> mineData) {
...
//            Log.e("每行最大高度dp:",mRowMaxHeights.toString());
    ...
    private void initView() {
        mineScrollView = (CustomHorizontalScrollView) mTableView.findViewById(R.id.mineHeadView_ScrollView);
        mineTitleView= (TextView) mTableView.findViewById(R.id.mineHeadView_Text);
        mineTitleView.setTextColor(ContextCompat.getColor(mContext, R.color.border_color));
        mineTitleView.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTextViewSize);
        mineTitleView.setText(mColumnTitle);
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) mineTitleView.getLayoutParams();
        ...
        mineTitleView.setLayoutParams(layoutParams);
        mineTitleView.setText(mineData.get(0));
        mineData.remove(0);
...
//                Log.e("横向滚动监听","["+x+"] "+"["+y+"]");
    ...
    private void creatHeadView() {
        createScollview(mineScrollView,mineData,false);
        mScrollViews.add(mineScrollView);
        mineScrollView.setOnScrollChangeListener(new CustomHorizontalScrollView.onScrollChangeListener() {
            @Override
     ...
     * @param isFristRow 是否是第一行
     */
    private void createMineScollview(HorizontalScrollView scrollView, List<String> datas, boolean isFristRow) {
        //设置LinearLayout
        LinearLayout linearLayout = new LinearLayout(mContext);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.MATCH_PARENT);
